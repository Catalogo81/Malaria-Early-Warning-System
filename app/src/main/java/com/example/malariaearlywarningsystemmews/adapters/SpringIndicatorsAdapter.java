...
public class SpringIndicatorsAdapter extends FirebaseRecyclerAdapter<SpringIndicators, SpringIndicatorsAdapter.MySpringViewHolder> {
     ...
     * @param springOptions
     */
    public SpringIndicatorsAdapter(@NonNull FirebaseRecyclerOptions<SpringIndicators> springOptions) {
        super(springOptions);
    }

    @Override
    protected void onBindViewHolder(@NonNull SpringIndicatorsAdapter.MySpringViewHolder holder, int position, @NonNull SpringIndicators model) {
    ...
    @NonNull
    @Override
    public SpringIndicatorsAdapter.MySpringViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_items, parent, false);

        return new SpringIndicatorsAdapter.MySpringViewHolder(view);
    }

    class MySpringViewHolder extends RecyclerView.ViewHolder
    {
        TextView tvIndicator;

        public MySpringViewHolder(@NonNull View itemView) {
            super(itemView);
